    ...
    Sub MainLanguageLoader(LanguageSelected As String)
        Select Case LanguageSelected
            Case "en"
                ...
                HelpTextVar(1) = "gethardware ---  Launch GetHardwareInfo() allowing you to see all the hardware info VB can access useful for developing"
            ...
            Case "fr"
                'setting up TextVar
                TextVar(0) = "Bienvenu sur just for fun si tu as besoin d'aide écrit 'help' pour avoir la liste des commandes"
                TextVar(1) = "Chargement..."
                TextVar(2) = "Cette commande n'existe pas écrit 'help' pour voir tout les commandes"
                HelpTextVar(0) = "Ceci est la liste des programmes disponibles actuellement"
                HelpTextVar(1) = "gethardwareinfo ---  Lance GetHardwareInfo() ce qui vous permet de voir tous les infos matérielles que VB peut avoir accès utile pour les développeurs"
                HelpTextVar(2) = "setlanguage ---  Lance SetLanguage() ce qui vous permet de changer la langue de l'application"
                HelpTextVar(3) = "Plus à venir..."
                HelpTextVar(4) = "Appuyez sur entrer pour continuez..."
                SetLanguageTextVar(0) = "Bienvenu sur SetLanguage"
                SetLanguageTextVar(1) = "Quel language veux-tu sélectionner ?"
